...
1. Push your modified code to a new branch in the [GitHub repository](https://github.com/openairinterface/oai-cn5g-udm).
   * Please use a short and descriptive branch name.

2. Create a pull request on [GitHub](https://github.com/openairinterface/oai-cn5g-udm/pulls).
...
Please report software bugs or security issues through the [GitHub Issue Tracker](https://github.com/openairinterface/oai-cn5g-udm/issues).
